...
|-----------------|------------------|-----------|------------|
| **Análise da receita da empresa Megaline** | [Projeto_Megaline](https://github.com/pedrob0892/megaline-incomes-analysis) | Python, Tableau, Pandas, Seaborn | **Projeto de receitas e teste de hipóteses.** Tratamento de dados, análise exploratória, correlações e insights principais com gráficos, teste de hipóteses e conclusões/recomendações. Dashboard Interativo. Investigar qual dos planos gera mais receita para a empresa, com o objetivo de ajustar o orçamento de publicidade. |
